        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-800 font-medium">{search ? 'ไม่พบรายงานที่ค้นหา' : 'ยังไม่มีรายงานปัญหา'}</p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="bg-red-500 hover:bg-red-600 text-white text-sm font-semibold py-2 px-4 rounded-lg transition disabled:opacity-60"
                    >
                      {deletingId === report.id ? '...' : 'ลบ'}
                    </button>
                  </div>
                </div>
              ))}
        ...
        >
          ...
          >
            ...
            <div className="p-6 space-y-4">
              {viewingReport.detail && (
                <div>
                  <h4 className="font-semibold text-gray-700 mb-2">รายละเอียด:</h4>
                  <p className="text-gray-600 whitespace-pre-wrap">{viewingReport.detail}</p>
                </div>
              )}

              {viewingReport.imageUrl && (
                <div>
                  <h4 className="font-semibold text-gray-700 mb-2">รูปภาพประกอบ:</h4>
                  <img 
